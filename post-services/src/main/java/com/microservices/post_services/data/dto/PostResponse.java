...
public class PostResponse {
    ...
    public PostResponse(Long id, String titulo, String contenido, String tag, LocalDateTime fechaDeCreacion, LocalDateTime fechaDeModificacion, int numeroDeCometarios) {
        this.id = id;
        this.titulo = titulo;
